...
instance = nova.servers.create(name="Mohamad_prod_server_with_docker_"+str(identifier), image=image, flavor=flavor, key_name='mhdkey2',userdata=userdata, nics=nics,security_groups=secgroups)
